...
```gradle
dependencies {
    implementation 'com.tiktok.open.sdk:tiktok-open-sdk-core:2.0.1'
    implementation 'com.tiktok.open.sdk:tiktok-open-sdk-auth:2.0.1'   // to use authorization api
    implementation 'com.tiktok.open.sdk:tiktok-open-sdk-share:2.0.1'    // to use share api
}
```
