    ...
    private fun initRecyclerViewData() {
        mainViewModel.mainViewState.observe(this) { viewState ->
            val recyclerViewDataModel = mutableListOf(
                ...
                EditTextModel(EditTextType.CLIENT_KEY, R.string.demo_app_title_client_key, R.string.demo_app_title_client_secret_key, hint = BuildConfig.CLIENT_KEY, text = viewState.customizedClientKey, enabled = viewState.customizeEnabled),
                initInfoText(),
            )
