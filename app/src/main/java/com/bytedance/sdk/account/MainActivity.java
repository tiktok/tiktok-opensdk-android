...
import com.bytedance.sdk.open.aweme.douyin.DouYinConstants;
...
import com.bytedance.sdk.open.aweme.douyin.base.BaseVideoObject;
import com.bytedance.sdk.open.aweme.douyin.base.DouYinAnchorObject;
import com.bytedance.sdk.open.aweme.douyin.base.DouYinImageObject;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static int targetAppId = 1; // 默认抖音
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (id) {
                    case R.id.app_aweme:
                        ...
                        createTiktokApiImpl(DouYinConstants.TARGET_APP.AWEME);
                        break;
                    case R.id.app_tiktok:
                        targetAppId = DouYinConstants.TARGET_APP.TIKTOK;
                        IS_AUTH_BY_M = false;
                        createTiktokApiImpl(DouYinConstants.TARGET_APP.TIKTOK);
                        break;
    ...
    private boolean share(int shareType) {
        ...
        switch (shareType) {
            ...
            case Share.VIDEO:
                ...
                DouYinAnchorObject anchorObject = new DouYinAnchorObject();
