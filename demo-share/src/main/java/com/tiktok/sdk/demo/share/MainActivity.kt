...
import com.tiktok.sdk.demo.share.model.EditTextModel
import com.tiktok.sdk.demo.share.model.EditTextType
import com.tiktok.sdk.demo.share.model.HeaderModel
import com.tiktok.sdk.demo.share.model.InfoModel
import com.tiktok.sdk.demo.share.model.LogoModel
    ...
    private fun initRecyclerViewData() {
        mainViewModel.mainViewState.observe(this) { viewState ->
            val recyclerViewDataModel = mutableListOf(
                ...
                EditTextModel(
                    EditTextType.CLIENT_KEY,
                    R.string.demo_app_title_client_key,
                    R.string.demo_app_title_client_secret_key, hint = BuildConfig.CLIENT_KEY, text = viewState.clientKey, enabled = viewState.customizeEnabled
                ),
                initInfoText(),
            )
