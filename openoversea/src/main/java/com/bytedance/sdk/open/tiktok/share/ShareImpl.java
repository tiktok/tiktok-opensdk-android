...
public class ShareImpl {
    ...
    public boolean share(String localEntry, String remotePackageName, String remoteRequestEntry, Share.Request request, String remotePlatformEntryName, String sdkName, String sdkVersion) {
        if (TextUtils.isEmpty(remotePackageName) || request == null || mContext == null) {
            ...
            if (TextUtils.isEmpty(request.getCallerLocalEntry())) {
...
//                bundle.putString(Keys.Share.CALLER_LOCAL_ENTRY, mContext.getPackageName() + "." +localEntry);
            ...
            if (request.getExtras() != null) {
                bundle.putBundle(Keys.Base.EXTRA, request.getExtras());
            }
            ...
            bundle.putString(Keys.Share.OPENPLATFORM_EXTRA, request.getShareExtra());
            if (request.getAnchor() != null) {
                bundle.putString(Keys.Share.ANCHOR_SOURCE_TYPE, request.getAnchor().getSourceType());
            }
            bundle.putSerializable(Keys.Share.EXTRA_SHARE_OPTIONS, request.getExtraShareOptions()); // TOOD: chen.wu move this shareoptions wit this key in bundle
            bundle.putInt(Keys.Share.SHARE_FORMAT, request.getShareFormat().getFormat());
