...
abstract class AppCheckBase(open val context: Context): IAppCheck {
    override val remoteAuthEntryActivity: String = "openauthorize.AwemeAuthorizedActivity"
    ...
    override val isShareFileProviderSupported: Boolean
        get() = isAppSupportAPI(packageName, remoteAuthEntryActivity, Keys.API.SHARE_SUPPORT_FILEPROVIDER)

    override fun isAppSupportAPI(requiredApi: Int): Boolean {
        return isAppSupportAPI(packageName, remoteAuthEntryActivity, requiredApi)
    }
